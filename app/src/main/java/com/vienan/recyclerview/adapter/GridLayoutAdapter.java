 ...
 */
public class GridLayoutAdapter extends BaseNiceRecyclerViewAdapter<RecyclerView.ViewHolder,HeaderObject,ItemObject,FooterObject> {


    private Context context;
    private LayoutInflater inflater;
    private View footerView;
    public GridLayoutAdapter(Context context, View footerView) {
        ...
        if (manager instanceof GridLayoutManager) {
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    boolean isHeaderOrFooterPosition = isHeaderPosition(position)
                            || isFooterPosition(position);
                    return isHeaderOrFooterPosition ? gridManager.getSpanCount() : 1;
                }
            });
        }
    }
